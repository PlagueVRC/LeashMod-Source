...
namespace Leash.IL2CPPAssetBundleAPI
{
            ...
            try
            {
                ...
                if (stream != null && stream.Length > 0)
                {
                    ...
                    if (memStream != null && memStream.Length > 0)
                    {
                        ...
                        assetBundle = AssetBundle.GetAllLoadedAssetBundles_Native().First(o => o.GetAllAssetNames().Any(p => p.ToLower().Contains(".assetbundle")));
